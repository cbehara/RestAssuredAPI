...
@CucumberOptions(format = { "pretty" }, features = "src//test//java//com//factory//cucumber//features//DemoFeaturePost2.feature", glue = {
		"com.factory.cucumber.stepdefinitions" }, tags = { "@smoke, @get,@get1, @post, @put, @getfail, @postfail, @putfail" }, plugin = {
